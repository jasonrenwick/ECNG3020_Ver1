"""
Django settings for cocoawebsite project.
...
SECRET_KEY = '^e5%x=d9-^x(ytnp_4w55k8k#wld0+sm((8=rjt2j5#c242*_%'
...
ROOT_URLCONF = 'cocoawebsite.urls'
...
WSGI_APPLICATION = 'cocoawebsite.wsgi.application'
